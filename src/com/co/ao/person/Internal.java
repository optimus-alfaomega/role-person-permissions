...
public class Internal implements Person {
    ...
    private String description = "user worker by internal way for a Company";
    ...
    public Internal(String name, String id, int age, int yearBithdate, int monthBirthdate, int dayBirthdate,
            String civilStatus, String idJob, Role role) {
        this.name = name;
        this.id = id;
        this.age = age;
    ...
    public Internal(String name, String id, int age, int yearBithdate, int monthBirthdate, int dayBirthdate,
            Person partner, String civilStatus, String idJob, Role role) {
        this.name = name;
        this.id = id;
        this.age = age;
        this.birthdate = LocalDate.of(yearBithdate, monthBirthdate, dayBirthdate);
