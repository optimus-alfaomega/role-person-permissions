...
public class ThirdAgeOld implements Person {
    ...
    private String description = "third age person";
    ...
    public ThirdAgeOld(String name, String id, int age, int yearBithdate, int monthBirthdate, int dayBirthdate,
